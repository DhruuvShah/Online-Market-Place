  ...
  return (
    <div className="flex min-h-dvh flex-col overflow-x-clip">
      <header className="sticky top-0 z-50 border-b border-line bg-[color-mix(in_srgb,var(--color-canvas)_80%,transparent)] backdrop-blur-xl">
        {/* Controls sit left, the mark anchors the right, and the links ride in
            just ahead of it — right of centre without touching either edge. */}
        <nav className="shell flex h-16 items-center gap-4">
          ...
          <div className="flex flex-1 items-center justify-end gap-6 sm:gap-10">
