    ...
    <div className="shell py-8 sm:py-12">
      ...
      <div className="mt-8 grid gap-10 md:grid-cols-2 md:gap-14">
        <div className="flex flex-col gap-3">
          <div className="aspect-square overflow-hidden rounded-[var(--radius-lg)] bg-[var(--sunken)]">
            {images[activeImage] ? (
              <img
            ...
            <div className="grid grid-cols-5 gap-3">
              {images.map((image, index) => (
                <button
                  ...
                  className={`aspect-square overflow-hidden rounded-[var(--radius-sm)] border-2 transition-colors ${
                    index === activeImage
                      ? "border-[var(--ink)]"
        ...
        <div className="md:pt-2">
          ...
          {product.description && (
            <p className="mt-7 max-w-prose text-[15px] leading-relaxed text-[var(--ink-muted)]">
              {product.description}
            </p>
          )}
          ...
          <div className="mt-9 border-t border-[var(--border)] pt-7">
            <div className="flex flex-wrap items-center gap-4">
              <div className="inline-flex items-center rounded-full border border-[var(--border-strong)]">
                <button
                  ...
                  className="grid h-11 w-11 place-items-center rounded-l-full transition-colors hover:bg-[var(--sunken)] disabled:opacity-40"
                >
                ...
                <button
                  ...
                  className="grid h-11 w-11 place-items-center rounded-r-full transition-colors hover:bg-[var(--sunken)] disabled:opacity-40"
                >
            ...
            <p className="mt-5 text-[13px] leading-relaxed text-[var(--ink-subtle)]">
